...
impl Page {
    ...
    fn p4_index(&self) -> usize {
        (self.number >> 27) & 0x1FF /* get least significant 9 bits */
    }

    fn p3_index(&self) -> usize {
        (self.number >> 18) & 0x1FF /* get least significant 9 bits */
    }

    fn p2_index(&self) -> usize {
        (self.number >> 9) & 0x1FF /* get least significant 9 bits */
    }

    fn p1_index(&self) -> usize {
        (self.number >> 0) & 0x1FF /* get least significant 9 bis */
    }
...
// TODO ActivePageTable removed from here
    ...
    A: FrameAllocator,
{
    ...
    let mut new_table = {
        let frame = allocator.allocate_frame().expect("Can't allocate frames");
    ...
    active_table.with(&mut new_table, &mut temporary_page, |mapper| {
        ...
        for section in elf_sections_tag.sections() {
            ...
            println!(
                "mapping section at addr: 0x{:#x}, size: 0x{:#x}",
                section.addr,
                section.size
                );
    ...
    println!("Table switch");

    // turn the ol p4 into a guard page
